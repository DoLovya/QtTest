...
public:
    ...
    void setupUi(QWidget *MainWindowClass)
    {
        ...
        MainWindowClass->resize(767, 517);
        ...
        toolButton->setGeometry(QRect(230, 120, 121, 91));
        QIcon icon;
        ...
        layoutWidget->setGeometry(QRect(160, 310, 118, 72));
        ...
        groupBox_3->setGeometry(QRect(350, 260, 111, 121));
        ...
        pushButton_2->setGeometry(QRect(530, 310, 75, 23));
